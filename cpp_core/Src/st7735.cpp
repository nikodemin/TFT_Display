...
static const uint8_t
  init_cmds1[] = {            // Init for 7735R, part 1 (red or green tab)
    ...
    ST7735_MADCTL , 1      ,  // 14: Memory access control (directions), 1 arg:
      ST7735_MADCTL_MX | ST7735_MADCTL_MY,        //     row addr/col addr, bottom to top refresh
...
uint8_t *init_cmds(DisplayType *dt)
{
  uint8_t init_cmds1[] = {                                      // Init for 7735R, part 1 (red or green tab)
                                (dt->need_color_inversion) ? 22 : 21, // 15 commands in list:
                                ST7735_SWRESET, DELAY,                //  1: Software reset, 0 args, w/delay
                                150,                                  //     150 ms delay
                                ST7735_SLPOUT, DELAY,                 //  2: Out of sleep mode, 0 args, w/delay
                                255,                                  //     500 ms delay
                                ...
                                ST7735_CASET, 4,       //  1: Column addr set, 4 args, no delay:
                                0x00, 0x00,            //     XSTART = 0
                                0x00, dt->width - 1,   //     XEND
                                ST7735_RASET, 4,       //  2: Row addr set, 4 args, no delay:
                                0x00, 0x00,            //     XSTART = 0
                                0x00, dt->height - 1,                   // Init for 7735R, part 3 (red or green tab)
                                ST7735_GMCTRP1, 16, //  1: Gamma Adjustments (pos. polarity), 16 args, no delay:
                                0x02, 0x1c, 0x07, 0x12,
                                0x37, 0x32, 0x29, 0x2d,
                                0x29, 0x25, 0x2B, 0x39,
